        ...
        <Wrapper>
          <div className="flex flex-col md:flex-row items-start gap-10">
            ...
            <div className="md:w-1/2">
              <h2 className="text-4xl open-sans mb-6">
              ...
              <br />
              <h3 className="text-2xl font-unbounded mb-4">
                We encourage, educate, and equip today's children to be tomorrow's leaders
              </h3>
              <br />
              <h4 className="text-xl font-unbounded mb-2">
                The Golden Five-Point Kidzee Edges
              </h4>
              <br />
              <h5 className="text-2xl font-bold mb-4 text-black">Benefits of Enrolling:</h5>
              ...
              <br /><br />
              <button className="bg-orange-400 hover:bg-yellow-300 text-black font-semibold px-6 py-2 rounded-xl shadow-md transition">
    JOIN NOW→
  </button>
            </div>
            <div className="md:w-1/2">
